            ...
            <div >
                ...
                {(() => {
                    switch (this.state.value) {
                        case "1": return (languages.mcck.map(obj => <Error><Item obj={obj} /></Error>))
                        case "2": return (tf.map(obj => <Error><Item obj={obj} /></Error>))
                        case "3": return (mcs.map(obj => <Error><Item obj={obj} /></Error>))
                        case "4": return (mcms.map(obj => <Error><Item obj={obj} /></Error>))
                        case "5": return (multi.map(obj => <Error><MultiItem obj={obj} /></Error>))
                        default: return ("")
                    }
                })()}
...
const Item = props => {
    if(props== null){
        throw new Error('plz verify the value')
    }
    return (
        <div>
            <br />
